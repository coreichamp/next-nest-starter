import { Button, Grid, Paper, Typography, FormControl, FormControlLabel, InputLabel, FormHelperText, MenuItem } from '@material-ui/core';
    ...
    <Paper style={{ padding: 8 }}>
      ...
      <Form form={form} onSubmit={handleSubmit}>
        <Grid container spacing={2}>
          ...
          <Grid item md={6}>
          <FormControl>
            <TextField id="email" name="email" type="email" label="email" RHFInputProps={{ rules: { required: true } }}/>
